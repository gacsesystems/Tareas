...
export function CalendarView() {
	...
	const events = {
		...
		5: [{ type: 'cumpleanos', title: 'Cumpleaños Ana' }],
		6: [{ type: 'cobro', title: 'Cobro Startup XYZ', amount: '$25,000' }],
		10: [{ type: 'evento', title: 'Reunión equipo' }],
		15: [{ type: 'pago', title: 'Pago proveedor', amount: '$8,000' }],
		20: [{ type: 'cumpleanos', title: 'Cumpleaños Carlos' }],
		25: [{ type: 'evento', title: 'Conferencia tech' }],
	};
