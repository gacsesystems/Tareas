		...
		<Card>
			...
			<CardContent className="space-y-4">
				<div className="text-center">
					...
					<Badge variant={isBreak ? 'secondary' : 'default'} className="mb-3">
				...
				<div className="flex gap-2">
					<Button onClick={toggleTimer} className="flex-1" variant={isActive ? 'secondary' : 'default'}>
				...
				<div className="text-center text-sm text-muted-foreground">
					Pomodoros completados hoy: <span className="font-semibold text-accent">{completedPomodoros}</span>
				</div>
			</CardContent>
		</Card>
	);
